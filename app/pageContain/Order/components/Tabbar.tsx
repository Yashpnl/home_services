const Tabbar = ({ firstTab, secondTab = '', activeTab, setActiveTab }: { firstTab: string, secondTab?: string, activeTab: any, setActiveTab: any }) => {
    ...
    return (
        <>
            <div className="w-[90%] mx-auto bg-white shadow-[0px_3.84px_15.35px_0px_#D4E0EB] flex flex-col">
                <div className='flex items-center text-center justify-around sm:justify-start sm:gap-5 sm:px-16 w-full'>
                    <h2 className={`text-primary cursor-pointer sm:text-xl flex flex-col  items-center justify-center ${activeTab === firstTab ? "font-bold" : "font-normal"}`}
                        ...
                        {activeTab === firstTab ? (
                            <svg className="w-[100px] sm:w-full h-[35px]" viewBox="0 0 221 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        ) : <span className="w-[100px] sm:w-[221px] h-[35px]" />}
                    </h2>
